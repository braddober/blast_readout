...
class roachInterface(object):
	...
	neg_freqs, self.neg_delta = np.linspace(-246.001234e6+5.0e4, -10.02342e6, 50, retstep = True)
	pos_freqs, self.pos_delta = np.linspace(10.02342e6,246.001234e6, 50, retstep = True)
